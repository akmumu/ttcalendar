...
[下载最新版 macOS 安装包](https://github.com/akmumu/ttcalendar/releases/latest/download/ttcalendar.dmg) | [查看全部版本](https://github.com/akmumu/ttcalendar/releases)
...
添加小组件后即可一直显示，无需保持本应用启动，也不用让它在后台常驻。
