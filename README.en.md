...
[Download the latest macOS installer](https://github.com/akmumu/ttcalendar/releases/latest/download/ttcalendar.dmg) | [View all releases](https://github.com/akmumu/ttcalendar/releases)
