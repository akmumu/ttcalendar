...
struct WidgetDayCell: View {
            ...
            ZStack(alignment: .topTrailing) {
                ...
                if let customDate = day.customSpecialDate {
                    Text(customDate.customLabel)
                        ...
                        .foregroundStyle(customDate.categoryAccentColor)
    ...
    private var dayForeground: Color {
        ...
        if let customDate = day.customSpecialDate {
            return customDate.categoryAccentColor
        }
    ...
    private var cellBackground: some ShapeStyle {
        ...
        if let customDate = day.customSpecialDate {
            return customDate.categoryBackgroundColor
        }
...
extension CustomSpecialDate {
    var categoryAccentColor: Color {
        category.categoryAccentColor
    }
...
extension CustomSpecialDate.DateCategory {
    var categoryAccentColor: Color {
        switch self {
        case .work:
            return .blue
