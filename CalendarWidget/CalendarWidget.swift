...
struct Provider: TimelineProvider {
    ...
    private func makeEntry(date: Date, family: WidgetFamily) -> SimpleEntry {
        ...
        return SimpleEntry(
            ...
            nextCustomSpecialDay: highlights.nextCustomSpecialDay,
...
struct CalendarWidgetEntryView: View {
    ...
    private var extraLargeBody: some View {
        ...
        let customSpecialDay = entry.nextCustomSpecialDay
        ...
        return VStack(alignment: .leading, spacing: 8) {
            ...
            if showsBottomRow {
                ExtraLargeBottomRow(
                    ...
                    todayInfo: customSpecialDay != nil ? nil : entry.todayInfo,
...
struct NextSpecialDayBar: View {
    ...
    private var specialDayNameColor: Color {
        specialDay.customDateCategory?.categoryAccentColor ?? .red
    }
        ...
        if specialDay.isToday {
            HStack(alignment: .center, spacing: 4) {
                ...
                Text(specialDay.name)
                    ...
                    .foregroundColor(specialDayNameColor)
            }
            .lineLimit(1)
            ...
            HStack(alignment: .center, spacing: 4) {
                (Text("距").foregroundColor(.primary)
                    + Text(specialDay.name).foregroundColor(specialDayNameColor)
                    + Text("还有").foregroundColor(.primary))
                    .font(.system(size: 15, weight: .semibold, design: .rounded))
        ...
        HStack(spacing: 8) {
            if let todayInfo {
                ...
                ExtraLargeInfoItem(
                    ...
                    accent: customSpecialDay.customDateCategory?.categoryAccentColor ?? .purple
                )
            }
